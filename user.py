...
#The function validate_room_kwargs takes another function (function) as an argument, and it returns a new function (_validator) that performs the validation before
